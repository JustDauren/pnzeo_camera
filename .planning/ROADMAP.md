...
- [x] **Phase 5: Two-Way Audio** - Listen from camera and talk to camera over DRW channels with pure Python G.711 codec (completed 2026-04-02)
...
- [x] 04-02-PLAN.md -- MediaSource provider for browsing/downloading SD card recordings
...
- [x] 05-02-PLAN.md -- Audio services (listen, talk, stop), microphone switch, service registration
