...
- [x] **AUDI-01**: Listen to camera audio stream (DRW channel 2, G.711 A-law decode)
- [x] **AUDI-02**: Two-way talk (DRW channel 3, G.711 A-law encode + send)
- [x] **AUDI-03**: Microphone on/off switch (RTSetVoiceEnable)
